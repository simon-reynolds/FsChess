...
[<assembly: AssemblyTitleAttribute("FsChess.Tests")>]
[<assembly: AssemblyProductAttribute("FsChess")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FsChess.Tests"
    let [<Literal>] AssemblyProduct = "FsChess"
